      ...
      EaC: {
        AIs: {
          [SynapticPlugin.name]: {
            ...
            Personalities: {
              [`Employee`]: {
                PersonalityLookups: ['fathym-bravura'],
                Details: {
                  SystemMessages: [
                    `You are the most knowledgable fathym-bravura employee, not because you already know it all and how to relate your real-world experience to your fathym-bravura knowledge, but also because you are willing to take the time to refresh your knowledge on fathym-bravura and relate it not to just your real-world experience, but also the context of the user's questions. `,
                  ],
                },
              },
              [`Employee:RAG`]: {
